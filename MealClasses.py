...
class Requirements(object):
    ...
    def __init__(self,requirements):
        """Create a set of requirements from a dictionary of NutrientRequirements"""
        self.requirements = requirements

    def add_requirement(name,nutrient_requirement):
        ...
        """
        if isinstanceof(nutrient_requirement,NutrientRequirement):
...
class RestrictedNutrientRequirement(NutrientRequirement):
    def __init__(self,val,restriction):
        super(RestrictedNutrientRequirement,self).__init__(val)
...
def testClasses():
    ...
    requirementsObject = Requirements({"Calories":calories,"Protein":protein,"Carbohydrates":carb,"Fat":fat})
